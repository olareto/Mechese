...
public class Scr_ControlUI : MonoBehaviour {
    ...
    void Update() {
        ...
        {
            intro = personaje.GetComponent<Scr_Personaje>().Intro;
            vidas = personaje.GetComponent<Scr_Personaje>().Vidas;
            meta = personaje.GetComponent<Scr_Personaje>().Meta;
            monedas = personaje.GetComponent<Scr_Personaje>().Monedas;
        } else
        {
            intro = personaje.GetComponent<Scr_Personaje2>().Intro;
            vidas = personaje.GetComponent<Scr_Personaje2>().Vidas;
            meta = personaje.GetComponent<Scr_Personaje2>().Meta;
            monedas = personaje.GetComponent<Scr_Personaje2>().Monedas;
        }
